...
class Sim1SignalStrengthsListener(subId: Int) : PhoneStateListener() {
    ...
    override fun onSignalStrengthsChanged(signalStrength: SignalStrength) {
        ...
        when (getSignalStrengthsLevel(signalStrength)) {
            0 -> binding.icSilentSim1.setImageResource(R.drawable.ic_not_signal_sim)
            1 -> binding.icSilentSim1.setImageResource(R.drawable.ic_signal_sim_min)
            2 -> binding.icSilentSim1.setImageResource(R.drawable.ic_signal_sim_normal_min)
            3 -> binding.icSilentSim1.setImageResource(R.drawable.ic_signal_sim_normal_max)
            4 -> binding.icSilentSim1.setImageResource(R.drawable.ic_signal_sim_full)
        }
    }
